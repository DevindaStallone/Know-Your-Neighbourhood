      ...
      return(
       ...
       <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container px-8 px-lg-5">
                <a class="navbar-brand" href="/">KNOW-YOUR-NEIGBORHOOD</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item"><Link to="/login" id='#' class="nav-link" onClick={handleButtonClick}>Login</Link></li>
                        <li class="nav-item"><Link to="/register" id='#' class="nav-link" onClick={handleButtonClick}>Register</Link></li>
                        <li class="nav-item"><Link to="/aboutus" id='#' class="nav-link" onClick={handleButtonClick}>About Us</Link></li>
                        <li class="nav-item"><Link to="/contactus" id='#' class="nav-link" onClick={handleButtonClick}>Contact Us</Link></li>
                        <li class="nav-item"><Link to="/terms" id='#' class="nav-link" onClick={handleButtonClick}>Terms & Conditions</Link></li>
                    </ul>
                </div>
            </div>
        </nav>
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase">KNOW-YOUR-NEIGBORHOOD</h1>
                        <h2 class="text-white-50 mx-auto mt-2 mb-5">Post your store to get to Know Your Neigbours</h2>
